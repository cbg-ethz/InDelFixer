 ...
 */
public class FuturePaired implements Callable<Pair<String, List<Map<Integer, Map<Integer, Integer>>>>> {

    private FastqEntry watsonTriple;
    private FastqEntry crickTriple;
    private int L;
    ...
    public FuturePaired(FastqEntry watson, FastqEntry crick, int number) {
    ...
    public Pair<String, List<Map<Integer, Map<Integer, Integer>>>> call() {
        ...
        if (this.crickTriple != null) {
            Read crickRead = map(createRead(crickTriple, false));
            Read crickRevRead = map(createRead(crickTriple, true));

            Read crick = cut(align(crickRead.getMaximumHits() > crickRevRead.getMaximumHits() ? crickRead : crickRevRead, this.substitutionsBackward));
            if (crick != null) {
